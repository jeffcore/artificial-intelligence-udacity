...
If you use the Workspace, you do NOT need to perform any of the setup vteps outlined below. Skip to the next section with instructions for completing the project.
